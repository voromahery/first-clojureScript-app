...
var i_28265 = (self__.level + (1));
while(true){
if((i_28265 <= (new_level + (1)))){
(update[i_28265] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_28267 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28267[i]));
} else {
x__$2.forward.push((((i < links_28267.length))?(links_28267[i]):null));
}

if((i < links_28267.length)){
(links_28267[i] = x__$2);
} else {
links_28267.push(x__$2);
}
...
var i_28269 = (0);
while(true){
if((i_28269 <= self__.level)){
var links_28270 = (update[i_28269]).forward;
if((x__$1 === (((i_28269 < links_28270.length))?(links_28270[i_28269]):null))){
(links_28270[i_28269] = (x__$1.forward[i_28269]));

var G__28272 = (i_28269 + (1));
i_28269 = G__28272;
continue;
} else {
var G__28273 = (i_28269 + (1));
i_28269 = G__28273;
continue;
}
} else {
...
var G__28276 = nx;
var G__28277 = (level__$1 - (1));
x = G__28276;
level__$1 = G__28277;
continue;
} else {
var G__28278 = x;
var G__28279 = (level__$1 - (1));
x = G__28278;
level__$1 = G__28279;
continue;
}
