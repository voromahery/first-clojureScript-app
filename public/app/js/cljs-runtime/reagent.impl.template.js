...
var G__26953 = o;
reagent.impl.template.goog$module$goog$object.set(G__26953,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26973__i < G__26973__a.length) {G__26973__a[G__26973__i] = arguments[G__26973__i + 0]; ++G__26973__i;}
  args = new cljs.core.IndexedSeq(G__26973__a,0,null);
} 
...
var G__26954 = o;
reagent.impl.template.goog$module$goog$object.set(G__26954,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__26980__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__26980__delegate.call(this,args);};
G__26980.cljs$lang$maxFixedArity = 0;
G__26980.cljs$lang$applyTo = (function (arglist__26984){
var args = cljs.core.seq(arglist__26984);
return G__26980__delegate(args);
});
...
var G__26955 = props;
var G__26955__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26955,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26955);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26955__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26956 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26956,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26956;
}
})(),id_class);
...
var G__26957 = (cljs.core.count(argv) - first_child);
switch (G__26957) {
case (0):
...
var vec__26958 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26958,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26958,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26958,(2),null);
...
var temp__5757__auto___26998 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___26998 == null)){
} else {
var key_26999 = temp__5757__auto___26998;
(jsprops.key = key_26999);
}
...
var temp__5757__auto___27005 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___27005 == null)){
} else {
var key_27006 = temp__5757__auto___27005;
...
var temp__5757__auto___27008 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___27008 == null)){
} else {
var key_27009 = temp__5757__auto___27008;
(jsprops.key = key_27009);
}
...
var temp__5757__auto___27012 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27012 == null)){
} else {
var key_27016 = temp__5757__auto___27012;
(jsprops.key = key_27016);
}
...
var temp__5757__auto___27018 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___27018 == null)){
} else {
var key_27019 = temp__5757__auto___27018;
(jsprops.key = key_27019);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26961_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26961_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26962 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26962,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26962,(1),null);
...
break;
default:
var G__27024 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27025 = compiler;
v = G__27024;
compiler = G__27025;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26968 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26968 = (function (opts,id,fn_to_element,parse_fn,meta26969){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26968.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26970,meta26969__$1){
var self__ = this;
var _26970__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26968(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26969__$1));
}));

(reagent.impl.template.t_reagent$impl$template26968.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26970){
var self__ = this;
var _26970__$1 = this;
return self__.meta26969;
}));

(reagent.impl.template.t_reagent$impl$template26968.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26968.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26968.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26968.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26968.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26968.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26969","meta26969",224753983,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26968.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26968.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26968");

(reagent.impl.template.t_reagent$impl$template26968.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template26968");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26968.
 */
reagent.impl.template.__GT_t_reagent$impl$template26968 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26968(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26969){
return (new reagent.impl.template.t_reagent$impl$template26968(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26969));
});

}

return (new reagent.impl.template.t_reagent$impl$template26968(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
