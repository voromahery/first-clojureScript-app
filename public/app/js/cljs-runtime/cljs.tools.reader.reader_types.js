...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_26588 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26588(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26590 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26590(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26592 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26592(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26594 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26594(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26595 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26595(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26597 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26597(reader);
}
});
...
var G__26635 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__26636 = s.append(c);
c = G__26635;
s = G__26636;
continue;
}
